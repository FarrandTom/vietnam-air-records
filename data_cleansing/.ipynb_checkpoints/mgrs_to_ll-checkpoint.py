...
"""
This script focuses purely on the conversion of MGRS (Military Grid Reference System) coordinates to
lat lon coordinates. 

It is a stripped, and debugged version of: https://github.com/aydink/pymgrs

Implementation is pure python, and does not require any compile C libraries (such as https://pypi.org/project/mgrs/).
"""
...
def decode(mgrsString):
    ...
    if sep > 0:
        accuracyBonus = 100000.0 / math.pow(10, int(sep))
